...
| Creates, patches, state changes | *none* — they run directly | — |
...
Confirm the current verbs and flags with `gplay subscriptions --help`,
`gplay iap --help`, and `gplay <group> <command> --help` — both surfaces are
`[experimental]` (ADR-0010) and may still evolve.
